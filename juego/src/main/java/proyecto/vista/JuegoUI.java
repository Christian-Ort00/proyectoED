...
//
//        // Panel superior con tiempo, puntaje y botón salir
...
/**
 * UI principal del juego OverCooked-Fide.
 * Requisitos:
 * - Imágenes en: /src/main/resources/proyecto/imagenes/
 *   Ej: carne.jpeg, lechuga.jpeg, pan.jpg, queso.jpg
 * - MotorJuego, Hamburguesa e Ingrediente existentes en proyecto.juego
 * - Clase MenuPrincipal existente para volver al menú
 */
public class JuegoUI extends JFrame implements MotorJuego.TiempoListener {
    ...
    /** Carga y escala una imagen del classpath: /proyecto/imagenes/<file> */
    ...
    /** Mapea nombre de ingrediente -> archivo de imagen */
    ...
    /** Crea un label con ícono y (opcional) texto debajo */
